    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message.includes("quota")) {
          errorText = "I'm currently unavailable due to API quota limits. Please try again later or contact support.";
    ...
    <div className="flex flex-col h-full max-h-full overflow-hidden">
        ...
        <ConversationContent className="space-y-4">
          {messages.length === 0 ? (
            <ConversationEmptyState
              ...
              description="Ask me anything about sports highlights and videos!"
            />
          ) : (
      ...
      <div className="p-4 flex-shrink-0">
        <PromptInput onSubmit={handleSubmit}>
          <PromptInputBody>
            <PromptInputTextarea placeholder="Ask about sports highlights..." />
            <PromptInputToolbar>
              <div />
